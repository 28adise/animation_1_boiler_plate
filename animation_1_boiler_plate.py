...
# canvas variables
width = 1600 # adjust for width of canvas
...
# colors
background_color = 204,0,102

# initializing pygame, setting up the surface (canvas)
pygame.init()
canvas = pygame.display.set_mode((width, height))
pygame.display.set_caption("hi ella") # add a caption for your canvas

# import assets
sprite_sheet = pygame.image.load("sponge.png").convert_alpha() # add the path/name of your sprite sheet file
